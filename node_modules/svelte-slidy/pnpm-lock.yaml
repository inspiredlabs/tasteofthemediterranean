...
devDependencies:
  derver: 0.4.16
  esbuild: 0.12.9
  esbuild-svelte: 0.5.1_esbuild@0.12.9
  gh-pages: 3.2.1
  sass: 1.35.1
  svelte: 3.38.2
  svelte-preprocess: 4.7.3_sass@1.35.1+svelte@3.38.2
...
packages:
  ...
  /derver/0.4.16:
    resolution: {integrity: sha512-K7vRza7ZnaTXq74QBeQ6VOriGIxDVG76o/QqkWNYHrKa+Jr2BUjf3q5HvJfYWtlXMVdxQW+Gslm9n1ntTaX3pg==}
    hasBin: true
    dev: true
  ...
  /esbuild-svelte/0.5.1_esbuild@0.12.9:
    resolution: {integrity: sha512-df22x5t0zVjp/NVvFK5pF17U6C4A/2Ce1uE6oxk1Y081unR17/9PTZ/kVLlUDH4bgS7rlpFOULVqkawRFrM53w==}
    peerDependencies:
      esbuild: '>=0.9.6'
    dependencies:
      esbuild: 0.12.9
  ...
  /gh-pages/3.2.1:
    resolution: {integrity: sha512-/JLALwM9vTSohmaO9RZSWS+oCcVkV4pMyUwdQPZuxeJN5mVwz2kRbT6RigqDoqM8Rber2sv+WIMLP/9ZPfc7oA==}
    engines: {node: '>=10'}
    hasBin: true
    dependencies:
      async: 2.6.3
